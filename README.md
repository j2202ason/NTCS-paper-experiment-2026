# NTCS-paper-experiment-2026
An experimental program grounded in TRIZ theory, designed to solve non-typical inventive engineering problems.
...
- `experiments/` — The program runtime data is stored in Excel files, and the "experiments" folder is essential for the program's execution.
